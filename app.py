...
def main():
    ...
    **How It Works:**
    ...
    with st.form(key='job_description_form'):
        ...
        education = st.selectbox('Education', ['Diploma', 'Bachelor', 'Master', 'PhD'], index=1)
        ...
        skills = st.text_area('Skills', 'Proficient in Python, SQL, Big Data, AWS, Machine Learning, and Data Visualization tools.', help='List the skills required for the position')
